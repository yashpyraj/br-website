      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7 p-10">
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard
            ...
            description="Exclusive tools and features designed to enhance collaboration, strategy planning, and resource management for alliance mates in the Call of Dragons universe. Unlock powerful utilities to dominate the battlefield together."
            isComingSoon
            isRestricted
          />
        </BentoTilt>
